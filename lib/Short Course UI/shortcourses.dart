...
import 'package:bkiict_app/Template%20Models/coursecard.dart';
...
class _ShortCoursesState extends State<ShortCourses> with SingleTickerProviderStateMixin{
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const ShortCourses())); // Close the drawer
              },
            ),
            Divider(),
            ListTile(
